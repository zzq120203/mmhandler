...
public class StorageDescriptorImage implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private List<String> colsKeys; // required
	...
	public StorageDescriptorImage(List<String> colsKeys, String location,
			...
			SkewedInfo skewedInfo, boolean storedAsSubDirectories) {
		super();
		this.colsKeys = colsKeys;
	...
	public static StorageDescriptorImage generateStorageDescriptor(String dbName, String tblName, StorageDescriptor sd)
	{
		List<String> sdlkeys = new ArrayList<String>();
		for(int i = 0;i<sd.getCols().size();i++)
		{
			FieldSchema fs = sd.getCols().get(i);
			String colKey = dbName + "." + tblName + ".sdi." + fs.getName(); 
			sdlkeys.add(colKey);
		}
		return new StorageDescriptorImage(sdlkeys, sd.getLocation(), sd.getInputFormat(), 
	...
	public List<String> getColsKeys() {
		return colsKeys;
	}

	public void setColsKeys(List<String> colsKeys) {
		this.colsKeys = colsKeys;
	}
